...
<body>
    <header class="z-[99999999] fixed w-full max-w-[100vw] bg-[#502a29]" x-data="{showMtnl:false, showMenu:false, showMtnl2:false, x:0}">
        <div class=" p-3 flex justify-between align-center mx-auto max-w-screen-xl w-full">
            <div class="px-2">
                <a href="<?php echo page('home') ?>">
                    <img class="max-w-[80px]" src="<?php echo img("logo.png") ?>" alt="Le logo de la prestigieuse ecole FUTURE GENERATION">
                </a>
            </div>
        ...
        <ul class="md:flex justify-center items-center transition-all" x-show="showMenu" x-transition x-transition.duration.500ms style="display: none;">
            ...
            <li class="">
                <a class="px-3 py-3 w-full inline-block text-center font-semibold text-gray-200 transition-all hover:bg-[#ffbb00a9]/20 duration-300" href="<?php echo page('admissions') ?>">ADMISSIONS</a>
            </li>
            <li class="">
